...
template <> constexpr inline auto TransactionManager::qt_create_metaobjectdata<qt_meta_tag_ZN18TransactionManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(Transaction *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void TransactionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->transactionAdded((*reinterpret_cast< std::add_pointer_t<Transaction*>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TransactionManager::*)(Transaction * )>(_a, &TransactionManager::transactionAdded, 0))
            return;
    }
}
...
// SIGNAL 0
void TransactionManager::transactionAdded(Transaction * _t1)
{
